...
public class AesUtil {
    public static final String DEFAULT_KEY = "mobvoi";

    private static final String SHA1_PRNG = "SHA1PRNG";
    private static final int KEY_SIZE = 32;

    public static String encrypt(String content, String key) {
        return doEncryptOrDecrypt(content, key, Cipher.ENCRYPT_MODE);
    }

    public static String decrypt(String content, String key) {
        return doEncryptOrDecrypt(content, key, Cipher.DECRYPT_MODE);
    }

    @SuppressLint("GetInstance")
    private static String doEncryptOrDecrypt(String content, String password, @AESType int type) {
