package com.android.lib.ticpod.fastble.bluetooth;
...
import com.android.lib.ticpod.fastble.BleManager;
import com.android.lib.ticpod.fastble.callback.BleGattCallback;
import com.android.lib.ticpod.fastble.callback.BleIndicateCallback;
import com.android.lib.ticpod.fastble.callback.BleMtuChangedCallback;
import com.android.lib.ticpod.fastble.callback.BleNotifyCallback;
import com.android.lib.ticpod.fastble.callback.BleReadCallback;
import com.android.lib.ticpod.fastble.callback.BleRssiCallback;
import com.android.lib.ticpod.fastble.callback.BleWriteCallback;
import com.android.lib.ticpod.fastble.data.BleConnectStateParameter;
import com.android.lib.ticpod.fastble.data.BleDevice;
import com.android.lib.ticpod.fastble.data.BleMsg;
import com.android.lib.ticpod.fastble.exception.ConnectException;
import com.android.lib.ticpod.fastble.exception.OtherException;
import com.android.lib.ticpod.fastble.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        LogUtil.i("connect device: " + bleDevice.getName()
    ...
    private synchronized void refreshDeviceCache() {
        try {
            ...
            if (refresh != null && bluetoothGatt != null) {
                ...
                LogUtil.i("refreshDeviceCache, is success:  " + success);
            }
        } catch (Exception e) {
            LogUtil.i("exception occur while refreshing device: " + e.getMessage());
            e.printStackTrace();
        }
    }
            ...
            switch (msg.what) {
                case BleMsg.MSG_CONNECT_FAIL: {
                    ...
                    if (connectRetryCount < BleManager.getInstance().getReConnectCount()) {
                        LogUtil.e("Connect fail, try reconnect " + BleManager.getInstance().getReConnectInterval() + " millisecond later");
                        ++connectRetryCount;
                ...
                case BleMsg.MSG_STATE_CONNECTED: {
                    BleConnectStateParameter para = (BleConnectStateParameter) msg.obj;
                    int status = para.getStatus();
                    if (bleGattCallback != null)
                        bleGattCallback.onConnected(bleDevice, bluetoothGatt, status);
                }
                break;
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            LogUtil.i("BluetoothGattCallback：onConnectionStateChange "
                    + '\n' + "status: " + status
                    + '\n' + "newState: " + newState
                    + '\n' + "currentThread: " + Thread.currentThread().getId());
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                Message msgConnected = mainHandler.obtainMessage();
                msgConnected.what = BleMsg.MSG_STATE_CONNECTED;
                msgConnected.obj = new BleConnectStateParameter(status);
                mainHandler.sendMessage(msgConnected);
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            LogUtil.i("BluetoothGattCallback：onServicesDiscovered "
                    + '\n' + "status: " + status
                    + '\n' + "currentThread: " + Thread.currentThread().getId());
