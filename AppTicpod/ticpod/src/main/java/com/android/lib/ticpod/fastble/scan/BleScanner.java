package com.android.lib.ticpod.fastble.scan;
...
import com.android.lib.ticpod.fastble.callback.BleScanPresenterImp;
...
public class BleScanner {
    ...
    private synchronized void startLeScan(UUID[] serviceUuids, String[] names, String mac, boolean fuzzy,
        ...
        if (mBleScanState != BleScanState.STATE_IDLE) {
            LogUtil.w("scan action already exists, complete the previous scan action first");
            if (imp != null) {
