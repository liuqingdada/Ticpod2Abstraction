 ...
 * synchronized methods of the {@link BluetoothGatt BluetoothGatt} object.
 */
...
class Request {
    ...
    public @interface RequestType {
         ...
         * {@link BluetoothGatt#readCharacteristic(BluetoothGattCharacteristic) readCharacteristic}
         * method.</p>
         * <p>To use this type of request, a {@link Request Request} object has to be created through the
         ...
         * given characteristic. This request is used to define the call to the
         * {@link BluetoothGatt#writeCharacteristic(BluetoothGattCharacteristic) writeCharacteristic}
         * method.</p>
         * <p>To use this type of request, a {@link Request Request} object has to be created through the
         ...
         * {@link BluetoothGatt#readDescriptor(BluetoothGattDescriptor) readDescriptor} method.</p>
         * <p>To use this type of request, a {@link Request Request} object has to be created through the
         ...
         * <p>To get the needed parameters for the
         * {@link BluetoothGatt#readDescriptor(BluetoothGattDescriptor) readDescriptor} method,
         ...
         * <p>This request type describes the request from this device to the remote device to write values on the
         * given descriptor. This request is used to define the call to the
         * {@link BluetoothGatt#writeDescriptor(BluetoothGattDescriptor) writeDescriptor} method.</p>
         * <p>To use this type of request, a {@link Request Request} object has to be created through the
         ...
         * to write.</p>
         * <p>To get the needed parameters for the
         * {@link BluetoothGatt#writeDescriptor(BluetoothGattDescriptor) writeDescriptor} method,
         ...
         * <p>To get the needed parameters for the
         * {@link BluetoothGatt#requestMtu(int) requestMtu} method, please use
    ...
    public static Request createCharacteristicNotificationRequest(@NonNull BluetoothGattCharacteristic characteristic,
                                                                  boolean notify) {
        return new Request(RequestType.CHARACTERISTIC_NOTIFICATION, characteristic, null, null, notify, 0);
    }
     ...
     * {@link BluetoothGatt#writeDescriptor(BluetoothGattDescriptor) writeDescriptor}
     * method.</p>
     *
     * @param descriptor
