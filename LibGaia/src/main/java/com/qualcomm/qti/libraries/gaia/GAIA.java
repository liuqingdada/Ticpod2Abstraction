...
public final class GAIA {
	...
	/**
     * <p>To identify a {@link Status} by its value.</p>
     *
     * @param status
     *              The status to identify.
     *
     * @return the {@link Status} corresponding to the value or {@link com.qualcomm.qti.libraries
     * .gaia.GAIA.Status#NOT_STATUS} if neither {@link Status} fits the value.
     */
    public static @Status int getStatus(byte status) {
        switch (status) {
	...
	/**
     * <p>To obtain a readable version of a {@link Status}.</p>
     *
     * @param status
     *              the status value.
     *
     * @return A string corresponding to the {@link Status} value.
     */
    ...
    /**
     * <p>To identify a {@link NotificationEvents} by its value.</p>
     *
     * @param event
     *              The event to identify.
     *
     * @return the {@link NotificationEvents} corresponding to the value or
     * {@link NotificationEvents#NOT_NOTIFICATION} if neither
     * {@link NotificationEvents} fits the value.
     */
    public static @NotificationEvents int getNotificationEvent(byte event) {
        switch (event) {
