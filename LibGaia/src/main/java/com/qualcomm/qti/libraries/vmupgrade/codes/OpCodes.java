...
public final class OpCodes {
    ...
    public @interface Enum {
         ...
         * message</b></dt><dd>{@link Enum#UPGRADE_SYNC_CFM UPGRADE_SYNC_CFM} from device.</dd> <dt><b>Next
         * message</b></dt><dd>{@link Enum#UPGRADE_START_CFM UPGRADE_START_CFM} from the device.</dd> </dl>
         */
         ...
         * message</b></dt><dd>{@link Enum#UPGRADE_START_REQ UPGRADE_START_REQ}</dd> <dt><b>Next
         * message</b></dt><dd>depends on the {@link ResumePoints} value received by the Host in the {@link
         * Enum#UPGRADE_SYNC_CFM UPGRADE_SYNC_CFM} message: <table> <tr> <td>{@link
         * ResumePoints.Enum#DATA_TRANSFER DATA_TRANSFER}</td> <td> &#8658; {@link Enum#UPGRADE_START_REQ} from
         * application.</td> </tr> <tr> <td>{@link ResumePoints.Enum#VALIDATION VALIDATION}</td> <td> &#8658; {@link
         * Enum#UPGRADE_IS_VALIDATION_DONE_REQ} from application.</td> </tr> <tr> <td>{@link
         * ResumePoints.Enum#TRANSFER_COMPLETE TRANSFER_COMPLETE}</td> <td> &#8658; {@link
         * Enum#UPGRADE_TRANSFER_COMPLETE_RES} from application.</td> </tr> <tr> <td>{@link
         * ResumePoints.Enum#IN_PROGRESS IN_PROGRESS}</td> <td> &#8658; {@link Enum#UPGRADE_IN_PROGRESS_RES}
         * from application.</td> </tr> <tr> <td>{@link ResumePoints.Enum#COMMIT COMMIT}</td> <td> &#8658; {@link
         * Enum#UPGRADE_COMMIT_CFM} from application.</td> </tr> </table> </dd> </dl>
         */
         ...
         * Enum#UPGRADE_DATA UPGRADE_DATA} from application</li> <li>{@link Enum#UPGRADE_START_DATA_REQ
         * UPGRADE_START_DATA_REQ} from application</li> </ul> </dd> <dt><b>Next message</b></dt><dd>{@link
         * Enum#UPGRADE_DATA UPGRADE_DATA} from the application.</dd> </dl>
         */
         ...
         * message</b></dt><dd>{@link Enum#UPGRADE_DATA_BYTES_REQ UPGRADE_DATA_BYTES_REQ} from device.</dd>
         * <dt><b>Next message</b></dt><dd> <ul style="list-style-type:none"> <li>{@link
         * Enum#UPGRADE_IS_VALIDATION_DONE_REQ UPGRADE_IS_VALIDATION_DONE_REQ} from application.</li> <li>{@link
         * Enum#UPGRADE_DATA_BYTES_REQ UPGRADE_DATA_BYTES_REQ} from device.</li> </ul> </dd> </dl>
         */
         ...
         * <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_ABORT_CFM UPGRADE_ABORT_CFM} from device.</dd>
         * </dl>
         */
         ...
         * Enum#UPGRADE_ABORT_REQ UPGRADE_ABORT_REQ} from application.</dd> <dt><b>Next
         ...
         * <p/>
         * <dl> <dt><b>Content</b></dt><dd>none</dd> <dt><b>Previous message</b></dt><dd>{@link
         * Enum#UPGRADE_IS_VALIDATION_DONE_REQ UPGRADE_IS_VALIDATION_DONE_REQ} from application.</dd>
         * <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_TRANSFER_COMPLETE_RES
         * UPGRADE_TRANSFER_COMPLETE_RES} from application.</dd> </dl>
         */
        byte UPGRADE_TRANSFER_COMPLETE_IND = 0x0B;

        /**
         * <p>To respond to the {@link Enum#UPGRADE_TRANSFER_COMPLETE_IND UPGRADE_TRANSFER_COMPLETE_IND} message
         * .</p>
         * <p/>
         ...
         * message</b></dt><dd>{@link Enum#UPGRADE_TRANSFER_COMPLETE_IND UPGRADE_TRANSFER_COMPLETE_IND} from
         * device.</dd> <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_SYNC_REQ UPGRADE_SYNC_REQ} from
         ...
         * information.</dd> <dt><b>Previous message</b></dt><dd>{@link Enum#UPGRADE_START_CFM
         * UPGRADE_START_CFM} which should contain the Resume point 3: {@link ResumePoints.Enum#IN_PROGRESS
         * IN_PROGRESS}.</dd> <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_COMMIT_REQ UPGRADE_COMMIT_REQ}
         ...
         * Enum#UPGRADE_IN_PROGRESS_RES UPGRADE_IN_PROGRESS_RES} from the Host.</dd> <dt><b>Next
         * message</b></dt><dd>{@link Enum#UPGRADE_COMMIT_CFM UPGRADE_COMMIT_CFM} from the Host.</dd> </dl>
         */
        byte UPGRADE_COMMIT_REQ = 0x0F;

        /**
         * <p>To respond to the {@link Enum#UPGRADE_COMMIT_REQ UPGRADE_COMMIT_REQ} message from the board.</p>
         * <p/>
         ...
         * Enum#UPGRADE_START_CFM UPGRADE_START_CFM} from the Device which should contain the Resume point 4:
         * {@link ResumePoints.Enum#COMMIT COMMIT}.</li> <li>{@link Enum#UPGRADE_COMMIT_REQ UPGRADE_COMMIT_REQ}
         * from the Device.</li></ul></dd> <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_TRANSFER_COMPLETE_IND
         ...
         * <p/>
         * <dl> <dt><b>Content</b></dt><dd>none</dd> <dt><b>Previous message</b></dt><dd>{@link
         * Enum#UPGRADE_COMMIT_CFM UPGRADE_COMMIT_CFM} from Host.</dd> <dt><b>Next message</b></dt><dd>None,
         ...
         * <dt><b>Next message</b></dt><dd>{@link Enum#UPGRADE_SYNC_CFM UPGRADE_SYNC_CFM} from Device.</dd>
         * </dl>
         */
        byte UPGRADE_SYNC_REQ = 0x13;

        /**
         * <p>Used by the board to respond to the {@link Enum#UPGRADE_SYNC_REQ UPGRADE_SYNC_REQ} message.</p>
         * <p/>
         * <dl> <dt><b>Content</b></dt><dd>A {@link ResumePoints} value.</dd> <dt><b>Previous message</b></dt><dd>{@link
         * Enum#UPGRADE_SYNC_REQ UPGRADE_START_REQ} from Device.</dd> <dt><b>Next message</b></dt><dd>{@link
         * Enum#UPGRADE_START_REQ UPGRADE_START_REQ} from Device.</dd> </dl>
         */
         ...
         * <p/>
         * <dl> <dt><b>Content</b></dt><dd>none</dd> <dt><b>Previous message</b></dt><dd>{@link
         * Enum#UPGRADE_START_CFM UPGRADE_START_CFM} from Device.</dd> <dt><b>Next message</b></dt><dd>{@link
         * Enum#UPGRADE_DATA_BYTES_REQ UPGRADE_DATA_BYTES_REQ} from Device.</dd> </dl>
         */
         ...
         * Device: <ul><li>{@link Enum#UPGRADE_IS_VALIDATION_DONE_CFM UPGRADE_IS_VALIDATION_DONE_CFM}</li>
         * <li>{@link Enum#UPGRADE_DATA UPGRADE_DATA}</li> <li>{@link Enum#UPGRADE_START_CFM
         * UPGRADE_START_CFM}</li> </ul></dd> <dt><b>Next message</b></dt><dd>Two possibilities from Device:
         * <ul><li>{@link Enum#UPGRADE_IS_VALIDATION_DONE_CFM UPGRADE_IS_VALIDATION_DONE_CFM}</li> <li>{@link
         * Enum#UPGRADE_TRANSFER_COMPLETE_IND UPGRADE_TRANSFER_COMPLETE_IND}</li> </ul></dd> </dl>
         */
        byte UPGRADE_IS_VALIDATION_DONE_REQ = 0x16;

        /**
         * <p>Used by the Device to respond to the {@link Enum#UPGRADE_IS_VALIDATION_DONE_REQ
         * UPGRADE_IS_VALIDATION_DONE_REQ} message.</p>
         * <p/>
         * <dl> <dt><b>Content</b></dt><dd>none</dd> <dt><b>Previous message</b></dt><dd>{@link
         * Enum#UPGRADE_IS_VALIDATION_DONE_REQ UPGRADE_IS_VALIDATION_DONE_REQ} from Device.</dd> <dt><b>Next
         * message</b></dt><dd>{@link Enum#UPGRADE_IS_VALIDATION_DONE_REQ UPGRADE_IS_VALIDATION_DONE_REQ} from
         * Device.</dd> </dl>
         */
         ...
         * message</b></dt><dd>{@link Enum#UPGRADE_ERROR_WARN_IND UPGRADE_ERROR_WARN_IND} from Device.</dd>
     ...
     *
     * @param opCode
     *          The byte to obtain the corresponding {@link Enum OpCodes}.
     *
     * @return The corresponding OpCodes or -1 if not found.
     */
    public static @Enum int getOpCode(byte opCode) {
        switch (opCode) {
     ...
     */
    public static String getString(@Enum int opCode) {
        switch (opCode) {
            case Enum.UPGRADE_START_REQ:
