...
public final class ResumePoints {
     ...
     */
    public static String getLabel(@Enum int step) {
        switch (step) {
     ...
     *
     * @return The corresponding ResumePoint, and {@link Enum#DATA_TRANSFER} as the default one if the
     * value does not have a corresponding ResumePoint.
     */
    public static @Enum int getResumePoint (byte value) {
        switch (value) {
            case Enum.DATA_TRANSFER:
